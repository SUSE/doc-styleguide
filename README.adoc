...
* https://github.com/SUSE/doc-styleguide/raw/master/prebuilt/current/styleguide_2014-02.2-with_changelog.pdf[PDF with change log]
* https://github.com/SUSE/doc-styleguide/raw/master/prebuilt/current/styleguide_2014-02.2-plain.pdf[PDF without change log]
